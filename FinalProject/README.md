...
VectorFlow 是一个面向计算机图形学课程设计的矢量流程图编辑系统。它不只是能画流程图，还做了不少更像完整绘图软件的功能：画好的图形可以丢进物理沙盒里碰撞，SQL 可以一键生成 ER 图，常用图形组合可以存进自己的组件库，图片也可以导入到画布里继续排版和导出。
...
| 扩展实用功能 | 支持自定义组件库、SQL 一键生成 ER 图、图片导入和默认电路模板 |
